...
<?php echo $this->fetch('library/ur_here.lbi'); ?>
  <div id="pageLeft" class="fl">
    ...
    <h1 class="screen"><span style="margin-top:5px; display:block; margin-left:10px; color:#666666; font-size:14px;"><?php echo $this->_var['lang']['goods_filter']; ?></span></h1>
...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_22340400_1384915536');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_22340400_1384915536']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_22340400_1384915536']['filter_attr_name']); ?>：</strong>
			<?php $_from = $this->_var['filter_attr_0_22340400_1384915536']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
