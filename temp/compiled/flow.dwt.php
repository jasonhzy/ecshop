			...
			<tr>
				<td bgcolor="#ffffff" align="center">
					...
					<?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
						<a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img width="92px" height="92px" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a>
					<?php else: ?>
						<a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img width="92px" height="92px" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a><br />
					...
					<a href="javascript:void(0)" onclick="setSuitShow(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6"><?php echo $this->_var['goods']['goods_name']; ?><span style="color:#FF0000;">（<?php echo $this->_var['lang']['remark_package']; ?>）</span></a> <img src="themes/68ecshop_jumeifree/images/package.gif" />
...
?>
				...
				<?php endif; ?>
				<td align="center" bgcolor="#ffffff" class="price1"><?php echo $this->_var['goods']['goods_price']; ?></td>
				...
				<td align="center" bgcolor="#ffffff" class="price1"><?php echo $this->_var['goods']['subtotal']; ?></td>
				<td align="center" bgcolor="#ffffff">
	...
	<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" class="floatTable">
		<tr>
			<td align="right"><a style="margin-right:10px;" href="./"><img src="themes/68ecshop_jumeifree/images/continue.gif" /></a><a href="flow.php?step=checkout"><img src="themes/68ecshop_jumeifree/images/checkout.gif" /></a></td>
		</tr>
	</table>
 <?php if ($_SESSION['user_id'] > 0): ?>
...
?>
			...
			<?php endif; ?>
			<td bgcolor="#ffffff" align="center"  class="price1"><?php echo $this->_var['goods']['formated_goods_price']; ?></td>
			<td bgcolor="#ffffff" align="center"><?php echo $this->_var['goods']['goods_number']; ?></td>
			<td bgcolor="#ffffff" align="center"  class="price1"><?php echo $this->_var['goods']['formated_subtotal']; ?></td>
		</tr>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
		...
		<tr>
			...
			<td bgcolor="#ffffff" colspan="3"><textarea name="card_message" cols="80" rows="3"  class="InputBorder"><?php echo htmlspecialchars($this->_var['order']['card_message']); ?></textarea></td>
		</tr>
	</table>
<?php endif; ?>
...
?>
		...
		<tr>
			...
			<td bgcolor="#ffffff"><textarea name="postscript" cols="95" rows="3" id="postscript" class="InputBorder"><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></textarea></td>
		</tr>
...
<div class="goodsTitle" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;"><?php echo $this->_var['lang']['fee_total']; ?></div>
	<?php echo $this->fetch('library/order_total.lbi'); ?>
	 <div align="center" style="margin:8px auto;">
		<input type="image" src="themes/68ecshop_jumeifree/images/bnt_subOrder.gif" />
...
function checkSignupForm(frm) {
  ...
  <div class="clearfix" style="margin-bottom:10px;" >
   ...
   <div class="step_login fl bg">
    <div class="login_tit blank" style="margin-top:15px;"><strong style="font-size:18px; margin-left:130px;">登录</strong> &nbsp;&nbsp;&nbsp;&nbsp;已经注册，请在此登录</div>
            ...
            <tr>
              <td colspan="2" align="center" bgcolor="#ffffff">
                  ...
                  <?php if ($this->_var['anonymous_buy'] == 1): ?>
                   <a onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" style="cursor:pointer" >
                   <em class="noLogin"></em></a>
                  <?php endif; ?>
   ...
   <div class="step_login fl bg" style="overflow:hidden; margin-left:12px">
   <div class="reg2_tit blank" style="width:575px; margin-top:15px;"><strong style="font-size:18px; margin-left:100px">注册</strong> &nbsp;&nbsp;&nbsp;&nbsp; 新用户？ 立即注册。</div>
