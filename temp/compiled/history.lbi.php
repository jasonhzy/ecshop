...
<h1 class="mod2tit" style="background:url(themes/68ecshop_jumeifree/images/sdgg.gif) repeat-x; height:27px;"><font  style="color:#000"><?php echo $this->_var['lang']['view_history']; ?></font></h1>
