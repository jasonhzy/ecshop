...
<div class="mod1 mod2 blank bg" id="topbox" style="background-color:#FFFFFF;">
	<h1 class="mod2tit" style="background:url(themes/68ecshop_jumeifree/images/sdgg.gif) repeat-x; height:27px; color:#000"><?php echo $this->_var['lang']['top10']; ?></h1>
...
?>
		  <li>
			 <div class="first">
			  <div class="fl">
				<font style="color:#DD0000; font-weight:bold"><?php echo $this->_foreach['top_goods']['iteration']; ?>.</font> <a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['short_name']; ?></a>
				</div>
