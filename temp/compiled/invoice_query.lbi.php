...
.vote form a{text-decoration:none;}
</style>
<div class="mod1 mod2 blank" id="invoice" style="background-color:#FFFFFF;">
	<h1 style="background:url(themes/68ecshop_jumeifree/images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px; font-size:14px; color:#000"><?php echo $this->_var['lang']['shipping_query']; ?></h1>
		<div class="mod2con">
