...
<script type="text/javascript" src="themes/68ecshop_jumeifree/js/mzp-packed-me.js"></script>
...
<a style=" border:1px solid #d2d0d0; width:350px; height:350px; display:block; padding:0;" href="<?php echo $this->_var['goods']['goods_img']; ?>" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>">
      <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="350px" height="350px" style="margin:0px;"/>
      
     </a>
         <?php else: ?>
         <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="350px" height="350px"/>
         <?php endif; ?>
...
<?php endif; ?>
		...
		<div class="goodstxtbox fr" style="width:815px;">
		  <h4 class="goodName">
...
?>
			...
			<?php echo $this->_var['lang']['goods_number']; ?><img src="themes/68ecshop_jumeifree/images/wuhuo.gif" />
			<?php else: ?>
            ...
            <span>
			<?php echo $this->_var['lang']['goods_rank']; ?> <img src="themes/68ecshop_jumeifree/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" />
            </span>
			</p>
...
?>
		  ...
		  <?php endif; ?>
			<div class="blank"></div>
			<a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/68ecshop_jumeifree/images/bnt_buy.jpg" /></a> 
            </div>
		</form>
