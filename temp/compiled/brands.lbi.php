...
<div class="mod1 mod2 blank brandboxs1" style="background-color:#FFFFFF;">
	<h1 class="mod2tit" style=" position:relative;background:url(themes/68ecshop_jumeifree/images/sdgg.gif) repeat-x; height:27px; color:#000">品牌专卖<a href="brand.php" class="more"><font style="color:#000">全部品牌</font></a></h1>
