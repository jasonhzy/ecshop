...
function orderSelectedResponse(result)
{
  ...
  try
  {
     ...
     if( result.pack_fee_formated){
		 ...
		 document.getElementById("empeisong").innerHTML = result.pack_fee_formated;
	     document.getElementById("peisong68").style.display = 'none';
		 document.getElementById('peisongip').className = 'i-icon-arrow-down'; 
	    }
	 if( result.card_fee_formated){
		 
		  document.getElementById("emheka").innerHTML = result.card_fee_formated;
	      document.getElementById("heka68").style.display = 'none';
		  document.getElementById('hekaip').className = 'i-icon-arrow-down'; 
		 }
		 	 if( result.pack_fee_formated){
		 
		  document.getElementById("embaozhuang").innerHTML = result.pack_fee_formated;
	      document.getElementById("baozhuang68").style.display = 'none';
		  document.getElementById('baozhuangip').className = 'i-icon-arrow-down'; 
		 }
...
function changeSurplusResponse(obj)
{
  ...
  else
  {
    try
    {
document.getElementById('yue68').style.display = 'none'; 
document.getElementById('emyue').innerHTML = "您使用了" +obj.surplusnum;
...
function changeIntegralResponse(obj)
{
  ...
  else
  {
    try
    {
		document.getElementById('jifen68').style.display = 'none'; 
document.getElementById('emjifen').innerHTML = "您使用了" +obj.integralnum;
...
function changeBonusResponse(obj)
{
  ...
  {
	document.getElementById('emhongbao').innerHTML = obj.type_money; 
	document.getElementById('hongbao68').style.display="none";
	document.getElementById('hongbaoip').className = 'i-icon-arrow-down'; 
    orderSelectedResponse(obj.content);
  }
}
...
if (obj.error)
  ...
  else
  {
	  	document.getElementById('hongbao68').style.display = 'none'; 
		document.getElementById('hongbaoip').className = 'i-icon-arrow-down'; 
		document.getElementById('emhongbao').innerHTML = "红包序列号" +obj.bonusnum;
    orderSelectedResponse(obj.content);
  }
}
